...
return [
    ...
    'App.uriPrefix' => '/phpboot-example/public/',
     ...
     ************************************************************************************/
    \Doctrine\Common\Cache\Cache::class => \DI\object(\Doctrine\Common\Cache\ArrayCache::class),
    ...
    \Psr\Log\LoggerInterface::class => \DI\object(\Monolog\Logger::class)
        ->constructor(\DI\get('host'))->method('pushHandler', \DI\get('defaultLoggerStream')),
